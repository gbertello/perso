cv = {
  "name": "Guillaume BERTELLO",
  "address": "537 chemin de beauvert, domaine de chateau vert, villa 21, 06 600 Antibes France",
  "telephone": "+33 6 24 21 46 19",
  ...
  "employmentItems": [
    {
      ...
      "descriptionItems": [
        "Creation of a <span class='subsection-emphasize'>Quality Assurance</span> department from 8 to 50 people",
        "Leading <span class='subsection-emphasize'>QA transformation</span> in terms of organization, recruitment, process definition, tools migration, activity transfer",
        "<span class='subsection-emphasize'>Wide functional perimeter</span> encompassing all Search, Shopping and Pricing products",
        "Handling of <span class='subsection-emphasize'>functional validation</span> advocating customer's perception and <span class='subsection-emphasize'>non-regression</span> with a focus on result determinism",
        "Implementation of <span class='subsection-emphasize'>continuous integration</span> and <span class='subsection-emphasize'>continuous delivery</span> principles by automating tests (80 000 tests run in 20mn)",
        "Manage professional staff, managers and conduct them through <span class='subsection-emphasize'>change</span>"
      ]
    },
    {
      "image": "img/amadeus.jpg",
      ...
      "descriptionItems": [
        "Management of a team of 4-5 people with <span class='subsection-emphasize'>wide transversal expertise</span>",
        "Pre-Sales, Implementation and Production Support activities for <span class='subsection-emphasize'>Airlines websites</span> search engines",
        "Handling of <span class='subsection-emphasize'>RFP answers</span>, workshops in various countries (Japan, Brazil, United Arab Emirates, India, ...), consultancy analysis"
      ]
    },
    {
      "image": "img/amadeus.jpg",
      ...
      "descriptionItems": [
        ...
        "Implementation of <span class='subsection-emphasize'>Agile methodologies</span>"
      ]
    },
    {
      "image": "img/amadeus.jpg",
  ...
  "hiddenEmploymentItems": [
    {
      "image": "img/csiro.jpg",
      "date": "(Mar 2004 - Jul 2004)",
      "location": "Perth, Australia",
      "title": "Internship - research assistant",
      "descriptionItems": [
        "Research on earthquake time series analysis"
      ]
    },
    {
      "image": "img/eurocopter.jpg",
      "date": "(Aug 2003)",
      "location": "Dallas, US",
      "title": "Worker intership",
      "descriptionItems": [
        "Worker in a warehouse"
      ]
    },
    {
      "image": "img/marine.jpg",
      "date": "(Nov 2001 - Jun 2002)",
      "location": "Papeete, Tahiti",
      "title": "Officier chef de quart",
      "descriptionItems": [
  ...
  "educationItems": [
    {
      ...
      "date": "(Sep 2004 - Jul 2006)",
      "location": "Palo Alto, US",
      "title": "Master's of electrical engineering",
      "descriptionItems": [
    ...
    {
      "image": "img/polytechnique.jpg",
      "date": "(Sep 2001 - Aug 2004)",
  ...
  "hiddenEducationItems": [
    {
      "image": "img/ginette.jpg",
      "date": "(Sep 1999 - Aug 2001)",
      "location": "Versailles, France",
      "title": "Ecole Sainte Geneviève",
      "descriptionItems": [
        "MPSI/MP* courses"
      ]
    },
    {
      "image": "img/lacordaire.jpg",
      "date": "(Sep 1992 - Aug 1999)",
      "location": "Marseille, France",
      "title": "Ecole Lacordaire",
      "descriptionItems": [
